...
\makebox[\textwidth][c]{
    \includegraphics[width=\textwidth]{../images/vs-species-table.png}
}
...
Use Nerah formally (as in English "terrain") with Grock and Ruz less formal and a generalization for planet and dirt grubbers
